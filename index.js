...
app.get('/app', (req, res) => {
  res.sendFile(path.join(process.cwd(), './static/unlocked.html'));
});
app.get('/x', (req, res) => {
...
server.listen(8080, () => console.log(`Doge Unblocker is listening on http://localhost:${server.address().port}`));
